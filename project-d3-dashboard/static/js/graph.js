...
function show_percent_that_are_professors(ndx, gender, element) {
    var percentagePeopleThatAreProf = ndx.groupAll().reduce(
        (p, v) => {
            if (v.sex === gender) {
                p.count++;
                if (v.rank === "Prof") {
    ...
    dc.numberDisplay(element)
        ...
        .group(percentagePeopleThatAreProf);
}
...
function show_average_salary(ndx) {
    ...
    var averageSalaryByGender = dim.group().reduce(addItem, removeItem, initReduce);
...
function show_rank_distribution(ndx) {
    ...
    dc.barChart("#rank-distribution")
        ...
        .stack(asstProfByGender, "Assist Prof")
